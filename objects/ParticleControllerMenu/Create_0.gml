...
part_type_sprite(global.p_dust, PGreen, false, false, false);// Use the animated sprite
...
part_type_size(global.p_dust, 0.25, 0.65, 0, 0);  // Size of particles, any value fom this range
